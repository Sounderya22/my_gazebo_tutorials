...
private:
    ...
    public:
        ...
        void execute(Robot& context) override {
            ...
            context.publishVelocity(0.0, 0.7);
        }
    };
...
private:
    void scanCallback(const sensor_msgs::msg::LaserScan::SharedPtr msg) {
        ...
        const float frontMinAngle = -0.3;  // Radians, approximately -11 degrees
        const float frontMaxAngle = 0.3;   // Radians, approximately 11 degrees
